namespace Sids.Prodesp.Core.Services.LiquidacaoDespesa
{
    ...
    public class SubempenhoEventoService : BaseService
    {
        private ICrudSubempenhoEvento _repository;


        public SubempenhoEventoService(ILogError log, ICrudSubempenhoEvento repository) : base(log)
        {
