namespace Sids.Prodesp.Core.Services.LiquidacaoDespesa
{
    ...
    public class SubempenhoNotaService : BaseService
    {
        private ICrudSubempenhoNota _repository;


        public SubempenhoNotaService(ILogError log, ICrudSubempenhoNota repository) : base(log)
        {
