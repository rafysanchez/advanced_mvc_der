namespace Sids.Prodesp.Core.Services.LiquidacaoDespesa
{
    ...
    public class SubempenhoCancelamentoNotaService : BaseService
    {
        private ICrudSubempenhoCancelamentoNota _repository;


        public SubempenhoCancelamentoNotaService(ILogError log, ICrudSubempenhoCancelamentoNota repository) : base(log)
        {
