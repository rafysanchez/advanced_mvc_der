namespace Sids.Prodesp.Core.Services.LiquidacaoDespesa
{
    ...
    public class RapAnulacaoNotaService : BaseService
    {
        private ICrudRapAnulacaoNota _repository;


        public RapAnulacaoNotaService(ILogError log, ICrudRapAnulacaoNota repository) : base(log)
        {
