namespace Sids.Prodesp.Model.Entity.Reserva
{
    ...
    public class Reserva : IReserva
    {
        ...
        /// Codigo do Programa
        /// </summary>
        [Display(Name = "Número Reserva Prodesp")]
        [Column("nr_reserva_prodesp")]
        public string NumProdesp { get; set; }

        /// <summary>
        /// Numero reserva Siafem com Siafisco
        /// </summary>
        [Display(Name = "Número Reserva Siafem/Siafisico")]
        [Column("nr_reserva_siafem_siafisico")]
        ...
        /// Ano de referencia
        /// </summary>
        [Display(Name = "Ano Referencia")]
        [Column("nr_ano_referencia_reserva")]
