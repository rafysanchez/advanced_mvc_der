namespace Sids.Prodesp.Model.Entity.Reserva
{
    ...
    public class ReservaCancelamento: IReserva
    {
        //  Properties
        ...
        /// <summary>
        /// Codigo do Cancelamento Prodesp
        /// </summary>
        [Display(Name = "Número do Cancelamento Prodesp")]
        [Column("nr_cancelamento_prodesp")]
        public string NumProdesp { get; set; }

        /// <summary>
        /// Numero do refoço Siafem com Siafisco
        /// </summary>
        [Display(Name = "Número do Cancelamento Siafem/Siafisico")]
        [Column("nr_cancelamento_siafem_siafisico")]
        ...
        [Column("dt_emissao_cancelamento")]
        ...
        [Display(Name = "")]
        [Column("cd_cfp")]
        public string CfpPrograma { get; set; }    //propriedade provem da tabela "tb_programa" , campo não existente na tabela "tb_cancelamento",mas utilizado na procedure: [PR_REFORCO_CONSULTAR_GRID]

        [Display(Name = "")]
        [Column("ds_programa")]
        public string DescricaoPrograma { get; set; }    //propriedade provem da tabela "tb_programa" , campo não existente na tabela "tb_cancelamento",mas utilizado na procedure: [PR_REFORCO_CONSULTAR_GRID]

        [Display(Name = "")]
        [Column("cd_natureza")]
        public string NaturezaEstrutura { get; set; } //propriedade provem da tabela "tb_estrutura" , campo não existente na tabela "tb_cancelamento", mas utilizado na procedure: [PR_REFORCO_CONSULTAR_GRID]
