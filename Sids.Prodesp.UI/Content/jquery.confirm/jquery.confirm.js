...
(function ($) {
    ...
    $.confirm = function (options, e) {
        ...
        if (settings.cancelButton != '') {
            cancelButtonHtml =
                '<button class="cancel btn ' + settings.cancelButtonClass + '" type="button" data-dismiss="modal"><i class="fa fa-close"></i> ' +
        ...
        if (settings.confirmButton != '') {
            confirmButtonHtml =
                '<button class="confirm btn ' + settings.confirmButtonClass + '" type="button" data-dismiss="modal"><i class="fa fa-check"></i> ' +
                    settings.confirmButton +
                '</button>';
        }

        //Versão original Jquery Confirm
        /*var modalHTML =
        ...
        var modalHTML = '<div id="modalConfirmaExclusao" class="modal fade" data-focus-on="input:first" data-backdrop="static" data-keyboard="' + settings.datakeyboard + '" style="word-wrap: break-word;">' +
                        '<div class="' + settings.dialogClass + '" role="document" data-backdrop="static">' +
                            '<div class="modal-content">' +
                                '<div class="modal-header">' +
                                ...
                                '<div class="modal-body text-center">' +
                                    '<span>' + settings.text + '<i class="fa text-warning"></i></span>' +
                                '</div>' +
                                '<div class="modal-footer footer-modal">' +
                                    //'<button type="button" class="btn btn-sm btn-danger" ><i class="fa fa-check"></i> Sim</button>' +
                                    confirmButtonHtml +
                                    //'<button type="button" class="btn btn-sm btn-primary" ><i class="fa fa-close"></i> Não</button>' +
                                    cancelButtonHtml +
                                '</div>' +
                            '</div>' +
                        '</div>' +
