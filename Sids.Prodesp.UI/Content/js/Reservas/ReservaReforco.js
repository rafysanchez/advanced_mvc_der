        ...
        .on('submit', function (e) {
            ...
            if (hasError) {
                ...
                if (tans == "T") {
                    ...
                    e.preventDefault();
                    window.location.href = '/Reserva/ReservaReforco/Edit/' + $("#Codigo").val() + '?tipo=i';
                }
            }
        });
...
function Salvar() {
    ...
    var dtoReservaReforcoSalvar = { Reforco: ModelItem, ReforcoMes: listMes };
    var object = JSON.stringify(dtoReservaReforcoSalvar);
    ...
    $.ajax({
        datatype: 'json',
        type: 'Post',
        url: "/Reserva/ReservaReforco/Save",
        cache: false,
        async: false,
        data: object,
        ...
        success: function (dados) {
            if (dados.Status == "Sucesso") {
                ...
                $.confirm({
                    ...
                    title: "Confirmação",
                    cancel: function () {
                        window.location.href = '/Reserva/ReservaReforco/Edit/' + dados.Id + '?tipo=a';
                    },
                    cancelButton: "Fechar",
                    confirmButton: ""
                });
...
function Transmitir() {
    ...
    Transmissao(object, "ReservaReforco");
}
...
function CarregarMes() {
    ...
    $.each($("div > #Valor"), function (index, value) {
        ...
        if (value.value != "" && valor > 0) {
            ...
            listMes[listMes.length] = reforcoMes;
        }
    });
}
