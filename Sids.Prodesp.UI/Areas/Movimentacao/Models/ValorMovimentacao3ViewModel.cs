namespace Sids.Prodesp.UI.Areas.Movimentacao.Models
{
    ...
    public class ValorMovimentacao3ViewModel
    {
        ...
        [Display(Name = "Q1")]
        public string TotalQ1 { get; set; }
        [Display(Name = "Q2")]
        public string TotalQ2 { get; set; }
        [Display(Name = "Q3")]
        public string TotalQ3 { get; set; }
        [Display(Name = "Q4")]
        public string TotalQ4 { get; set; }


        public string Total { get; set; }


        public ValorMovimentacao3ViewModel CreateInstance(int modelId, IEnumerable<MovimentacaoMes> meses)
        {
            var dictionary = meses
                .Where(w => w.IdReducaoSuplementacao == modelId)
                .Select(s => new { s.Descricao, s.ValorMes })
                .ToDictionary(d => d.Descricao, d => d.ValorMes);

            return dictionary.Any() ?
                new ValorMovimentacao3ViewModel()
                {
