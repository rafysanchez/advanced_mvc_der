namespace Sids.Prodesp.UI.Areas.Movimentacao.Models
{
    ...
    public class ValorMovimentacaoViewModel
    {
        ...
        public ValorMovimentacaoViewModel CreateInstance(int modelId, IEnumerable<MovimentacaoMes> meses)
        {
            ...
            return dictionary.Any() ?
                new ValorMovimentacaoViewModel()
                {
