...
{
    public class ReservaReforcoViewModel : IReservaViewModel
    {
        ...
        public IReservaViewModel GerarViewModel(IReserva entity)
        {
            ...
            var mes = App.ReforcoMesService.Buscar(new ReservaReforcoMes { Id = entity.Codigo }).Cast<IMes>().ToList();

            IReservaViewModel viewModel = new ReservaReforcoViewModel();
            viewModel.Anos = App.ReservaReforcoService.ObterAnos();
