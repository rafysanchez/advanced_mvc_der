CREATE TABLE [reserva].[tb_reforco] (
    [id_reforco]                        INT           IDENTITY (1, 1) NOT NULL,
    [id_fonte]                          INT           NULL,
    ...
    CONSTRAINT [PK_tb_reforco] PRIMARY KEY CLUSTERED ([id_reforco] ASC),
    CONSTRAINT [FK_tb_reforco_tb_estrutura] FOREIGN KEY ([id_estrutura]) REFERENCES [configuracao].[tb_estrutura] ([id_estrutura]),
    CONSTRAINT [FK_tb_reforco_tb_fonte] FOREIGN KEY ([id_fonte]) REFERENCES [configuracao].[tb_fonte] ([id_fonte]),
    CONSTRAINT [FK_tb_reforco_tb_programa] FOREIGN KEY ([id_programa]) REFERENCES [configuracao].[tb_programa] ([id_programa]),
    CONSTRAINT [FK_tb_reforco_tb_regional] FOREIGN KEY ([id_regional]) REFERENCES [seguranca].[tb_regional] ([id_regional])
);
