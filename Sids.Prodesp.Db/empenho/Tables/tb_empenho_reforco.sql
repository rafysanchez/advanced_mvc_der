CREATE TABLE [empenho].[tb_empenho_reforco] (
    [id_empenho_reforco]                    INT           IDENTITY (1, 1) NOT NULL,
    ...
    [bl_contBec]                            BIT           NULL,
    CONSTRAINT [PK_tb_empenho_reforco] PRIMARY KEY CLUSTERED ([id_empenho_reforco] ASC),
    CONSTRAINT [FK_tb_empenho_reforco_tb_aquisicao_tipo] FOREIGN KEY ([tb_aquisicao_tipo_id_aquisicao_tipo]) REFERENCES [empenho].[tb_aquisicao_tipo] ([id_aquisicao_tipo]),
    CONSTRAINT [FK_tb_empenho_reforco_tb_fonte] FOREIGN KEY ([tb_fonte_id_fonte]) REFERENCES [configuracao].[tb_fonte] ([id_fonte]),
    CONSTRAINT [FK_tb_empenho_reforco_tb_licitacao] FOREIGN KEY ([tb_licitacao_id_licitacao]) REFERENCES [empenho].[tb_licitacao] ([id_licitacao]),
    CONSTRAINT [FK_tb_empenho_reforco_tb_modalidade] FOREIGN KEY ([tb_modalidade_id_modalidade]) REFERENCES [empenho].[tb_modalidade] ([id_modalidade]),
    CONSTRAINT [FK_tb_empenho_reforco_tb_origem_material] FOREIGN KEY ([tb_origem_material_id_origem_material]) REFERENCES [empenho].[tb_origem_material] ([id_origem_material]),
    CONSTRAINT [FK_tb_empenho_reforco_tb_regional] FOREIGN KEY ([tb_regional_id_regional]) REFERENCES [seguranca].[tb_regional] ([id_regional])
);
