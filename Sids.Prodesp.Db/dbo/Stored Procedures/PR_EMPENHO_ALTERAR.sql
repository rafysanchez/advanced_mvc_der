...
-- ===================================================================  
CREATE PROCEDURE [dbo].[PR_EMPENHO_ALTERAR]      
	@id_empenho int,
...
BEGIN    
	...
	UPDATE empenho.tb_empenho
	SET 
	  tb_regional_id_regional = nullif( @tb_regional_id_regional, 0 )
	, tb_empenho_tipo_id_empenho_tipo = nullif( @tb_empenho_tipo_id_empenho_tipo, 0 )
	...
	, cd_ugo_obra = @cd_ugo_obra
	, nr_ano_contrato = @nr_ano_contrato
	, nr_mes_contrato = @nr_mes_contrato
	, nr_obra = @nr_obra
	, dt_entrega_material = @dt_entrega_material
	, ds_logradouro_entrega = @ds_logradouro_entrega
	, ds_bairro_entrega = @ds_bairro_entrega
	, ds_cidade_entrega = @ds_cidade_entrega
	, cd_cep_entrega = @cd_cep_entrega
	, ds_informacoes_adicionais_entrega = @ds_informacoes_adicionais_entrega
	...
	, ds_acordo = @ds_acordo
	, nr_contrato_fornecedor = @nr_contrato_fornecedor
	, nr_edital = @nr_edital
	, ds_referencia_legal = @ds_referencia_legal
	...
	, ds_status_siafisico_ne = @ds_status_siafisico_ne
