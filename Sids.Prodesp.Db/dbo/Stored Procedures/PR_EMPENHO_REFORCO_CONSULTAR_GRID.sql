...
-- =================================================================== 
CREATE PROCEDURE [dbo].[PR_EMPENHO_REFORCO_CONSULTAR_GRID]  
...
begin  
 ...
 SET NOCOUNT ON;  
	...
	where
		...
		( nullif( @tb_licitacao_id_licitacao, -1 ) is null or tb_licitacao_id_licitacao = @tb_licitacao_id_licitacao ) and
