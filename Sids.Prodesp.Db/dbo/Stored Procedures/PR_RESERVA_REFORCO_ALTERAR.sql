...
-- ALTER date: 05/12/2016
-- Description:	Procedure para alterar Reforço de Reserva 
-- ==============================================================

CREATE PROCEDURE [dbo].[PR_RESERVA_REFORCO_ALTERAR]
	@id_reforco int = null
,	@id_fonte int = null
...
begin
	...
	begin transaction
		...
		,	nr_reforco_prodesp = @nr_reforco_prodesp
		,	nr_reforco_siafem_siafisico = @nr_reforco_siafem_siafisico
		,	cd_obra = @cd_obra
		,	nr_oc = @nr_oc
		,	cd_ugo = @cd_ugo
		,	cd_uo = @cd_uo
		...
		,	dt_emissao_reforco = @dt_emissao_reforco
