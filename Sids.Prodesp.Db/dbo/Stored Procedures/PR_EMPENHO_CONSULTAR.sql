...
-- Description: Procedure para consultar empenhos
-- =================================================================== 
CREATE PROCEDURE [dbo].[PR_EMPENHO_CONSULTAR]
	@id_empenho int = 0,
...
begin  
 ...
 SET NOCOUNT ON;  
	...
	where
		( nullif( @id_empenho, 0 ) is null or id_empenho = @id_empenho )
        And ( nullif( @tb_regional_id_regional, 0 ) is null or tb_regional_id_regional = @tb_regional_id_regional )
	Order by id_empenho
end;