...
-- Description: Procedure para alteração do cancelamento do subempenho
-- ===================================================================  
CREATE PROCEDURE [dbo].[PR_SUBEMPENHO_CANCELAMENTO_ALTERAR]      
...
BEGIN    
	...
	update pagamento.tb_subempenho_cancelamento set 
			...
			,	tb_cenario_id_cenario							= @tb_cenario_id_cenario
			...
			,	tb_evento_tipo_id_evento_tipo					= @tb_evento_tipo_id_evento_tipo
			...
			,	cd_classificacao_despesa						= @cd_classificacao_despesa
